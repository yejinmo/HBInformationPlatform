...
namespace CGI_LibrarySystemBookInfo
{
...
<html>
<head>
    <title>LibrarySystemBookInfo</title>
</head>
<body>" +
res + @"
</body>
...
");
        ...
        static Struct_LibrarySystemBookInfo res_struct = new Struct_LibrarySystemBookInfo();

        static string Host_URL = "http://10.10.57.76:8080/opac/";
        static string url = string.Empty;
        static string username = "null";

        private static string Get(string USERNAME, string URL)
        {
            username = USERNAME;
