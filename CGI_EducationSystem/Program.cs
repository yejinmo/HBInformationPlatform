...
namespace CGI_EducationSystem
{
    public class Program
    {
        ...
        static string HtmlTemplateV3 = @"<html>    <head>        <meta charset=""utf-8"">        <meta http-equiv=""X-UA-Compatible"" content=""IE=edge"">        <meta name=""viewport"" content=""width=device-width, initial-scale=1"">        <link href=""css/base.css"" rel=""stylesheet"">        <link href=""css/project.css"" rel=""stylesheet"">        <title>教务信息系统</title>    </head>    <body class=""page-brand"">        <header class=""header header-transparent header-waterfall ui-header affix-top"">            <ul class=""nav nav-list pull-left"">                <li>					<a data-toggle=""menu"" href=""#ui_menu"">						<span class=""icon icon-lg"">menu</span>					</a>				</li>            </ul>            <nav class=""tab-nav pull-right hidden-xx"">                <ul class=""nav nav-justified"">                    <li class=""active"">						<a class=""waves-attach waves-effect"" data-toggle=""tab"" href=""#selector1"">  课表  </a>					</li>                    <li>						<a class=""waves-attach waves-effect"" data-toggle=""tab"" href=""#selector2"">  成绩  </a>					</li>                    <li>						<a class=""waves-attach waves-effect"" data-toggle=""tab"" href=""#selector3"">  考试  </a>					</li>                </ul>                <div class=""tab-nav-indicator"">				</div>            </nav>        </header>        <nav aria-hidden=""true"" class=""menu"" id=""ui_menu"" tabindex=""-1"" style=""display: none;"">            <div class=""menu-scroll"">                <div class=""menu-content"">                    <a class=""menu-logo"" href=""index.html"">首页</a>					                    <ul class=""nav"">                        <li>                            <a class=""collapsed waves-attach waves-effect"" data-toggle=""collapse"" href=""#ui_menu_samples"">教务信息系统</a>							                            <ul class=""menu-collapse collapse"" id=""ui_menu_samples"">                                <li>									<a class=""waves-attach waves-effect"" data-toggle=""tab"" href=""#selector1"">  课表  </a>								</li>                                <li>									<a class=""waves-attach waves-effect"" data-toggle=""tab"" href=""#selector2"">  成绩  </a>								</li>                                <li>									<a class=""waves-attach waves-effect"" data-toggle=""tab"" href=""#selector3"">  考试  </a>								</li>                            </ul>                        </li>                    </ul>                </div>            </div>        </nav>        <main class=""content"">            <div class=""content-header ui-content-header"">                <div class=""container"">                    <div class=""row"">                        <div class=""col-lg-6 col-lg-offset-3 col-md-8 col-md-offset-2"">                            <h1 class=""content-heading"">教务信息系统</h1>                        </div>                    </div>                </div>            </div>            <div class=""container"">                <div class=""row"">                    <section class=""content-inner margin-top-no"">                        <div class=""card-inner"">                            <div class=""tab-content"">                                <div class=""tab-pane fade active in"" id=""selector1"">                                    <center>                                    <br>									                                    <h1 class=""content-sub-heading"">                                        <!-->替换.课表.标题<-->									                                    </h1>                                    <center>                                    <!-->替换.课表.内容<-->														                                </div>                                <div class=""tab-pane fade"" id=""selector2"">					<center>                                    <br>									                                    <h1 class=""content-sub-heading"">                                        <!-->替换.成绩.标题<-->									                                    </h1>                                    <center>                                    <!-->替换.成绩.内容<-->												                                </div>                                <div class=""tab-pane fade"" id=""selector3"">					<center>                                    <br>									                                    <h1 class=""content-sub-heading"">                                        <!-->替换.考试.标题<-->									                                    </h1>                                    <center>                                    <!-->替换.考试.内容<-->												                                </div>                            </div>                        </div>                    </section>                </div>            </div>        </main>        <script src=""js/jquery.min.js""></script>		<script src=""js/base.min.js""></script>		<script src=""js/project.min.js""></script>	    </body></html>";
        [STAThread]
...
" + res);
        ...
        private static string Get_V2(string USERNAME, string PASSWORD)
        {
            ...
            try
            {
                ...
                #region 预处理
                {
                    ...
                    string final = "<html><head><meta charset=\"gb2312\"><meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge\"><meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"><link href=\"mui-0.7.4/css/mui.min.css\" rel=\"stylesheet\" type=\"text/css\" /><script src=\"mui-0.7.4/js/mui.min.js\"></script><style>body {font-family: \"Microsoft YaHei\"}</style></head><body><center><div class=\"mui-panel\"><strong>";
                    {
                        Regex reg = new Regex("<option selected=\"selected\" value=.*?>(.*?)</option>");
                        MatchCollection mc = reg.Matches(html);
                        if (mc.Count == 2)
                            final += mc[0].Groups[1].ToString() + " 学年度第 " + mc[1].Groups[1].ToString() + @" 学期学生个人课程表";
                    }
                    {
                    ...
                    final = final.Replace("align=\"Center\"", "").Replace("blacktab", "mui-table mui-table--bordered").Replace("border=\"1\"", "").Replace("bordercolor=\"Black\"", "");
                    FinalResultHtml = final;
        ...
        private static string Get_V3(string USERNAME, string PASSWORD)
        {
